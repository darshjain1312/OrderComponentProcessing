...
class ProcessIntegralServiceTest {
	...
	public void setUp() throws Exception{
		...
		processService = new ProcessIntegralService(processResponseRepository,processRequestRepository,packagingAndDeliveryFeignClient);
		loadProcessResponse();
	}
